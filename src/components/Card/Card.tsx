    ...
    return (
        <div className="cardMain">
            ...
            <Dropdown
                ...
                content="Subscriptions must be cancelled at least 20 days in advance of your next payment, at which point your subscription will last until the end of the subscription period."
            />
            <Dropdown
